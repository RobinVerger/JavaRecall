...
public class PlayingWithAlgoTest {
	...
	public void exportWordWithoutALetter() {
		...
		assertEquals("Lannister, Stark, Greyjoy, Targaryen, Arthur",
				PlayingWithAlgo.exportWordWithoutALetter(arrayIn, 'z'));
	}
	...
	public void titleize() {
		assertEquals("The Lion the Witch and the Wardrobe",
				PlayingWithAlgo.titleize("the lion the witch and the wardrobe"));
		assertEquals("The Lion the Witch. And the Wardrobe",
				PlayingWithAlgo.titleize("the lion the witch. and the wardrobe"));
	}
